...
export function EpubViewer({ file, onClose }: FileEditorProps) {
	const handleClose = () => {
		onClose()
	}
	...
	return (
		<div className="flex h-full flex-col bg-white dark:bg-dark-100">
			...
			<div className="flex flex-1 items-center justify-center overflow-auto bg-neutral-100 p-8 dark:bg-dark-200">
				<div className="max-w-4xl rounded-lg bg-white p-8 shadow-lg dark:bg-dark-100">
					<p className="text-center text-neutral-600 dark:text-dark-700">
						EPUB files cannot be previewed directly in the browser.
						<br />
						Please download the file to read it in an EPUB reader.
					</p>
				</div>
			</div>
		</div>
