  ...
  trello: createTRPCRouter({
    ...
    importBoards: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        // Array of random IDs for unique cover images
        const coverImageIds = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500];
        ...
        for (const boardId of input.boardIds) {
          ...
          // Generate unique cover image for each board
          const coverImageId = coverImageIds[boardsCreated % coverImageIds.length];
          const coverImage = `https://picsum.photos/id/${coverImageId}/800/400`;
