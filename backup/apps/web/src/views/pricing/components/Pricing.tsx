  ...
  const tiers = [
    {
      ...
      description: "Everything you need, free forever. Unlimited boards, unlimited lists, unlimited cards. Upgrade any time.",
    ...
    },
    {
      ...
      description: "Kanban is better with a team. Perfect for small and growing teams looking to collaborate.",
    ...
    },
    {
      ...
      description: "Host Kan on your own infrastructure. Ideal for organisations that need complete control over their data.",
      ...
      <div className="flex flex-col items-center justify-center px-4 pb-10">
        ...
        <div className="mt-14 flex flex-col items-center justify-center">
          <div className="mb-8 flex items-center gap-2 rounded-full border bg-white px-4 py-1.5 text-center text-xs font-bold text-gray-800 dark:border-dark-300 dark:bg-dark-1000 dark:text-gray-800 lg:text-sm">
            <HiBolt />
            <p>{"Launch offer: unlimited seats for just $29/month with Pro"}</p>
          </div>
